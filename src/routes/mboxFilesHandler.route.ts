...
/** Ping to controller */
router.get('/ping', auth, mboxFilesHandlerController.mboxHealthCheck);
...
router.post('/upload', auth, upload.array('files'), mboxFilesHandlerController.mboxFilesUpload);

/** Handle mbox files */
router.post('/handle', auth, mboxFilesHandlerController.mboxFileHandle);
